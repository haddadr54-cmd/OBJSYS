...
// Removido fallback hardcoded para evitar exposição acidental de projeto.
// Agora exige explicitamente que as variáveis estejam definidas (ou opera em modo offline localStorage).
...
if (!supabase) console.warn('[ConfigManager] Supabase não configurado (variáveis ausentes). Usando apenas localStorage.');
