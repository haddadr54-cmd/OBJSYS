...
// Sistema de Recuperação - Interface Visual Melhorada
export default function RecuperacaoPageSimple() {
      ...
      disciplinas: [
        ...
        { 
          ...
          avaliacoes: [
            ...
            { tipo: 'Redação', nota: 6.5, peso: 0.4 }
          ]
        }
      ]
    },
      ...
      disciplinas: [
        {
          ...
          avaliacoes: [
            ...
            { tipo: 'Seminário', nota: 7.0, peso: 0.2 }
          ]
        },
        {
          id: 'geo-1', 
  ...
  const handleSalvarNota = () => {
    if (selectedAluno && selectedDisciplina && notaRecuperacao && tipoAtividade) {
      ...
      alert(`✅ NOTA DE RECUPERAÇÃO REGISTRADA!\n\n${detalhes}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 p-6">
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2 text-xl font-semibold">Gestão inteligente e acompanhamento de alunos em recuperação</p>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-emerald-700">
                <strong>{alunosDemo.length}</strong> alunos em recuperação • Sistema funcionando perfeitamente
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-gray-100 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-blue-600 font-bold uppercase tracking-wide bg-blue-100 rounded-full px-3 py-1">Em Recuperação</p>
              </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-gray-100 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-black text-gray-500 uppercase tracking-widest mb-2">Média Geral</p>
                <p className="text-5xl font-black text-gray-900 mb-1">
        ...
        <div className="bg-gradient-to-r from-slate-50 via-gray-50 to-slate-100 p-8 border-b-2 border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-700 text-lg font-semibold">Selecione um aluno para registrar notas de recuperação acadêmica</p>
            </div>
              ...
              <div key={aluno.id} className={`relative overflow-hidden rounded-2xl transition-all duration-300 transform hover:scale-[1.02] ${
                ...
                <div className="relative p-6">
                  <div className="flex items-center justify-between mb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 text-sm mt-2">
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-gray-600 font-medium">Nº {aluno.numero}</span>
                          </div>
                          <div className="flex items-center space-x-1">
                    ...
                    >
                      {selectedAluno?.id === aluno.id ? '✓ Selecionado' : 'Selecionar Aluno'}
                    </button>
                  </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-sm font-medium text-gray-700 uppercase tracking-wide">
                      Disciplinas em Recuperação ({aluno.disciplinas.length})
                    </h4>
                      ...
                      <div key={idx} className="bg-white rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          {selectedAluno?.id === aluno.id && (
                            ...
                            >
                              {selectedDisciplina?.id === disciplina.id ? 'Selecionada ✓' : 'Registrar Nota'}
                            </button>
                          )}
                        </div>
                        ...
                        <div className="space-y-2">
                          <p className="text-xs font-medium text-gray-600 uppercase tracking-wide">Composição da Nota:</p>
      ...
      {selectedAluno && selectedDisciplina && (
        <div className="mt-8 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl shadow-2xl border-2 border-blue-300 p-8">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                {selectedAluno.nome} • {selectedDisciplina.nome} • Nota atual: {selectedDisciplina.nota}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  ...
                  <option value="Trabalho de Recuperação">📚 Trabalho de Recuperação</option>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Nota de Recuperação <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <input
                    type="number"
                ...
                {notaRecuperacao && (
                  <div className={`mt-1 text-sm font-medium ${
                    ...
                    {parseFloat(notaRecuperacao) >= 7.0 ? '✅ Aprovado' :
                     parseFloat(notaRecuperacao) >= 5.0 ? '⚠️ Ainda em Recuperação' : '❌ Reprovado'}
                  </div>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Digite observações sobre o desempenho do aluno, dificuldades identificadas, recomendações..."
                rows={6}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
              />
              <p className="text-xs text-gray-500 mt-1">
                Campo opcional - Use para registrar observações importantes
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            >
              ...
              <span>💾 SALVAR NOTA DE RECUPERAÇÃO</span>
            </button>
          </div>
        </div>
      )}
      ...
      {selectedAluno && !selectedDisciplina && (
        <div className="mt-6 bg-amber-50 border border-amber-200 rounded-lg p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h4 className="font-medium text-amber-800">Próximo Passo</h4>
              <p className="text-amber-700 text-sm">
                Selecione uma disciplina em recuperação para registrar a nota.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-blue-700 text-sm">
                ...
                2. Escolha a disciplina em recuperação<br/>
                3. Preencha o tipo de atividade e a nota<br/>
                4. Adicione observações se necessário<br/>
                5. Salve o registro
              </p>
            </div>
          </div>
